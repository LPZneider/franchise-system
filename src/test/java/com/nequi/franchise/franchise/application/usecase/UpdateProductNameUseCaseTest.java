...
class UpdateProductNameUseCaseTest {
    ...
    void setUp() {
        ...
        product = new Product("product-1", new Name("Original Product"), new Stock(10));
    ...
    @Test
    void execute_ShouldUpdateProductNameSuccessfully() {
        // Given
        ...
        // When
        Mono<ProductResponse> result = updateProductNameUseCase.execute(franchiseId, branchId, productId, newName);
    ...
    void execute_WhenBranchNotFound_ShouldThrowException() {
        ...
        // When
        Mono<ProductResponse> result = updateProductNameUseCase.execute(franchiseId, "non-existent-branch", productId, newName);
    ...
    void execute_WhenProductNotFound_ShouldThrowException() {
        ...
        // When
        Mono<ProductResponse> result = updateProductNameUseCase.execute(franchiseId, branchId, "non-existent-product", newName);
